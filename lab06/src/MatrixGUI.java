...
public class MatrixGUI {
	...
	public void setResultText(JTextArea textArea) {
    	...
    	String message = "";
		if (m.isSymmetric(clicked))
			message += "Symmetric?	True\n\n";
		else
			message += "Symmetric?	False\n\n";
		if (m.isDiagonal(clicked))
			message += "Diagonal?	True\n\n";
		else
			message += "Diagonal?	False\n\n";
		if (m.isIdentity(clicked))
			message += "Identity?	True\n\n";
		else
			message += "Identity?	False\n\n";
		message += "UpperTriangular?	";
		if (m.isUpperTriangular(clicked))
			message += "True\n\n";
		else
			message += "False\n\n";
		message += "Tridiagonal?	";
		if (m.isTridiagonal(clicked))
			message += "True\n\n";
		else
			message += "False\n\n";
